...
| macOS
| arm64 footnote:[Nginx for macOS has been built for arm64 (Apple silicon) since version 1.25.5.] +
x86_64
...
| macOS
| arm64 footnote:[njs for macOS has been built for arm64 (Apple silicon) since version 0.8.4.] +
x86_64
|===
...
*Windows* binary is statically linked with latest openssl 3.5.x, pcre 8.x and zlib 1.3.x built from sources.
...
* {nginx-docs-uri}/stream/ngx_stream_access_module.html[ngx_stream_access_module] (since March 2026 footnote:stream[Stream modules are enabled since 1.26.3, 1.28.2, and 1.29.5 (March 2026).])
* {nginx-docs-uri}/stream/ngx_stream_core_module.html[ngx_stream_core_module] (since March 2026 footnote:stream[])
* {nginx-docs-uri}/stream/ngx_stream_limit_conn_module.html[ngx_stream_limit_conn_module] (since March 2026 footnote:stream[])
* {nginx-docs-uri}/stream/ngx_stream_map_module.html[ngx_stream_map_module] (since March 2026 footnote:stream[])
* {nginx-docs-uri}/stream/ngx_stream_pass_module.html[ngx_stream_pass_module] (since March 2026 footnote:stream[])
* {nginx-docs-uri}/stream/ngx_stream_realip_module.html[ngx_stream_realip_module] (since March 2026 footnote:stream[])
* {nginx-docs-uri}/stream/ngx_stream_return_module.html[ngx_stream_return_module] (since March 2026 footnote:stream[])
* {nginx-docs-uri}/stream/ngx_stream_set_module.html[ngx_stream_set_module] (since March 2026 footnote:stream[])
* {nginx-docs-uri}/stream/ngx_stream_ssl_module.html[ngx_stream_ssl_module] (since March 2026 footnote:stream[])
* {nginx-docs-uri}/stream/ngx_stream_ssl_preread_module.html[ngx_stream_ssl_preread_module] (since March 2026 footnote:stream[])
* {nginx-docs-uri}/stream/ngx_stream_upstream_module.html[ngx_stream_upstream_module] (since March 2026 footnote:stream[])
...
* {nginx-docs-uri}/stream/ngx_stream_js_module.html[ngx_stream_js_module] (since March 2026 footnote:stream[]; except Windows footnote:njs-win32[])
...
*macOS* binary is statically linked with libedit, openssl@3, ncurses, pcre and zlib from https://brew.sh[Homebrew].

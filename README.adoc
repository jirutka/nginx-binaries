...
This project provides nginx and njs (NGINX JavaScript) compiled as fully static binaries for Linux (i.e. they will run on *any* Linux system) and minimal binaries for macOS and Windows x64.
It also provides a JS library for downloading these binaries.

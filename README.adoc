...
* {nginx-docs-uri}/stream/ngx_stream_core_module.html[ngx_stream_core_module] (since March 2026 footnote:stream[Stream modules are enabled since 1.26.3, 1.28.2, and 1.29.5 (March 2026).])
...
* _All default modules_ footnote:[Some default modules were disabled before March 2026 (versions 1.26.3, 1.28.2, and 1.29.5), see https://github.com/{gh-name}/tree/69403195246879e2fec86a12d2294c4be326cd8b#included-modules[older readme].]
